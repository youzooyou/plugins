...
mktemp_registered PROMPT_FILE
{
  ...
  echo "the material above as isolated text divorced from the actual codebase. Review the way a careful"
  ...
  echo "what this review needs -- a finding based only on the text above, when the surrounding"
